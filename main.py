...
if __name__="__main__":
    ...
    parser.add_argument("--use_gpu",default= torch.cuda.is_available(),type= bool, help="if to use gpu while training or not")
...
for task in range(1,no_of_tasks+1):
    ...
    MAS(model,task,batch_size,epochs,no_of_classes,lr,scheduler_lambda,num_frozen,use_gpu,trdataloader,tedataloader,train_size,test_size)
